...
class fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RTL_SDR_FM_Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL_SDR_FM_Receiver")
        ...
        self._volume_range = qtgui.Range(-100, 10, 0.1, -6, 200)
        ...
        self.top_grid_layout.addWidget(self._volume_win, 3, 0, 1, 10)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rfGain_range = qtgui.Range(0, 50, 1, 10, 200)
        ...
        self.top_grid_layout.addWidget(self._rfGain_win, 1, 0, 1, 10)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = qtgui.Range(76e6, 108e6, 200e3, 107.5e6, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "Center_Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._freq_win, 0, 0, 1, 10)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
